...
function __barracuda_prompt_bindmode -d 'Displays the current mode'
  ...
  switch $pwd_style
    case short long
      echo -n (set_color -o)" $pcount "(set_color normal)(set_color -b $barracuda_colors[5] $barracuda_current_bindmode_color)(set_color -b $barracuda_colors[5])(set_color -o 000)'{   }' (set_color normal)(set_color -b $barracuda_colors[2])(set_color $barracuda_colors[5])      
  end
